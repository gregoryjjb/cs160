...
/*
 * Begins outputting files from the given pipe to stdout
 * Returns the PID of the process managing the output.
 */
int outputFramesToStdOutFromPipe(const std::string& pipe,
                          const VideoMetadata& metadata);
/*
